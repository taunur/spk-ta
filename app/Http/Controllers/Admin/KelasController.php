...
class KelasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/employee/team')->with('success', "Tambah team baru berhasil");
    }
    ...
    public function update(KelasUpdateRequest $request, $id)
    {
        ...
        return redirect('/dashboard/employee/team')
            ->with('success', 'Team yang dipilih telah diperbarui!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()
            ->route('team.index')
            ->with('success', 'Team yang dipilih telah dihapus!');
    }
