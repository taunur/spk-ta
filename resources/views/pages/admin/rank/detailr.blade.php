            ...
            <div class="col-sm-6 col-md-8">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a href="{{ route('rank.show', $criteriaAnalysis->id) }}">Normalisasi
                            Tabel</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('rank.final', $criteriaAnalysis->id) }}">Karyawan Rank</a>
                    </li>
        ...
        <div class="card mb-4">
            <div class="card-body table-responsive">
                ...
                <div class="d-sm-flex align-items-center">
                    <div class="mb-4">
                        <h4 class="mb-0 text-gray-800">Normalisasi Alternatif Karyawan</h4>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                <table id="datatablesSimple" class="table table-bordered table-responsive">
                    <div class="mb-4">
                        <h4 class="mb-0 text-gray-800">Rangking Karyawan</h4>
                    </div>
