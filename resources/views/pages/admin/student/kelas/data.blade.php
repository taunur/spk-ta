        ...
        <div class="container-fluid px-4">
            ...
            <div class="card col-lg-10">
                <div class="card-body table-responsive">
                    <a href="{{ route('team.create') }}" type="button" class="btn btn-primary mb-3">
                                ...
                                @foreach ($kelases as $kelas)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('team.edit', $kelas->id) }}" class="badge bg-warning"><i
                                                    class="fa-solid fa-pen-to-square"></i></a>
                                            <form action="{{ route('team.destroy', $kelas->id) }}" method="POST"
                                                class="d-inline">
                                                @method('delete')
                                                @csrf
