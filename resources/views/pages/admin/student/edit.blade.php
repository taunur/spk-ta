...
@section('content')
    ...
    <form class="col-lg-8 contianer-fluid px-4 mt-3" method="POST" action="{{ route('employee.update', $student->id) }}"
        ...
        <a href="{{ route('employee.index') }}" class="btn btn-danger mb-3">Batal</a>
    </form>
@endsection
