...
@section('content')
    ...
    <form class="col-lg-8 contianer-fluid px-4 mt-3" method="POST" action="{{ route('employee.index') }}"
        enctype="multipart/form-data">
        @csrf
        {{-- NPK --}}
        <div class="mb-3">
            <label for="nis" class="form-label">NPK</label>
            <input type="number" id="nis" name="nis" maxlength="10"
                ...
                required placeholder="Masukan npk">
        ...
        {{-- Team --}}
        <div class="mb-3">
            <label for="kelas_id" class="form-label">Team</label>
        ...
        <a href="{{ route('employee.index') }}" class="btn btn-danger mb-3">Cancel</a>
    </form>
@endsection
