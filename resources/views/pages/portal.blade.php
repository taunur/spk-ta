...
@section('content')
    ...
    <section id="hero-animated" class="hero-animated d-flex align-items-center">
        <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative"
            ...
            <p>Sistem Pendukung Keputusan Pemilihan Karyawan Berprestasi</p>
            <div class="d-flex">
                @auth
                ...
                <div class="row d-flex justify-content-betwen text-center">
                    <div class="col-xl-3 col-md-6" data-aos="zoom-out">
                        <div class="service-item position-relative">
                            ...
                            <h4>
                                <a class="stretched-link"><span>{{ $students }}</span> Karyawan</a>
                            </h4>
                        </div>
                    </div>
                    <!-- End Service Item -->
            ...
            <div class="container" data-aos="fade-up">
                <div class="section-header">
                    ...
                    <p>
                        ...
                        solusi inovatif dalam pemilihan Karyawan berprestasi menggunakan
                        Sistem Pendukung Keputusan (SPK). Kami berkomitmen untuk membantu
                        sekolah, lembaga pendidikan, dan pihak terkait dalam proses
                        seleksi Karyawan berprestasi yang adil, obyektif, dan efisien.
                    </p>
                </div>
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active">
                                ...
                                <p>
                                    Penggunaan website untuk pemilihan Karyawan berprestasi dengan
                                ...
                                <p>
                                    ...
                                    menganalisis data calon Karyawan secara lebih mendalam.
                                </p>
                            </div>
                            <!-- End Tab 1 Content -->
                        </div>
